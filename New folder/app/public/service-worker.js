...
!(function () {
  ...
  !(function () {
      ...
      function k(e, t, r) {
        ...
        return function (a, i) {
          ...
          for (r.method = a, r.arg = i; ; ) {
            ...
            var o = f(e, t, r);
            if ("normal" === o.type) {
              if (((n = r.done ? "completed" : "suspendedYield"), o.arg === l)) continue;
        ...
        (C.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            return (
              (s.type = e),
              (s.arg = t),
              i ? ((this.method = "next"), (this.next = i.finallyLoc), l) : this.complete(s)
            );
          },
          ...
          finish: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
              ...
              if (r.finallyLoc === e) return this.complete(r.completion, r.afterLoc), L(r), l;
            }
          },
          catch: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
    ...
    function te(e) {
      return "function" === typeof e
        ...
        : (e instanceof IDBTransaction &&
          ...
          (t = e),
          (G || (G = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(
            function (e) {
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 4:
                              return (
                                (a = e.sent),
                                (i = a.transaction(ue, "readwrite", { durability: "relaxed" })),
                                (e.next = 8),
                                i.store.put(n)
                              );
                            case 8:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 18:
                              ...
                              return (f = h[u]), (e.next = 22), n.delete(ue, f.id);
                            case 22:
                              o.push(f.url);
                            case 23:
                              u++, (e.next = 18);
          ...
          if (null != r) {
            ...
            try {
              if (((i = (r = r.call(e)).next), 0 === t)) {
                ...
                for (; !(o = (n = i.call(r)).done) && (c.push(n.value), c.length !== t); o = !0);
            } catch (h) {
              (u = !0), (a = h);
            } finally {
              try {
                if (!o && null != r.return && ((s = r.return()), Object(s) !== s)) return;
              } finally {
                if (u) throw a;
              }
            }
                  ...
                  return R().wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            (t = S(this._cacheExpirations)), (e.prev = 1), t.s();
                          case 3:
                            if ((r = t.n()).done) {
                              e.next = 11;
                              break;
    ...
    function ye(e) {
      ...
      return i.searchParams.set("__WB_REVISION__", r), { cacheKey: i.href, url: s.href };
    }
    var be = i(function e() {
        var t = this;
        s(this, e),
                            ...
                            switch ((e.prev = e.next)) {
                              ...
                              case 9:
                                (i = this.hasCallback("fetchDidFail") ? n.clone() : null),
                                  (e.prev = 10),
                                  (s = S(this.iterateCallbacks("requestWillFetch"))),
                                  (e.prev = 12),
                                  s.s();
                              case 14:
                                if ((c = s.n()).done) {
                                ...
                                return (
                                  (o = c.value), (e.next = 18), o({ request: n.clone(), event: r })
                                );
                              case 18:
                                n = e.sent;
                              case 19:
                              ...
                              case 31:
                                if (
                                  ((e.prev = 31), (e.t1 = e.catch(10)), !(e.t1 instanceof Error))
                                ) {
                                  e.next = 35;
                                  break;
                                }
                              ...
                              case 39:
                                (h = e.sent),
                                  (f = S(this.iterateCallbacks("fetchDidSucceed"))),
                                  (e.prev = 42),
                                  f.s();
                              case 44:
                                if ((l = f.n()).done) {
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 8:
                              (n = e.sent),
                                (u = S(this.iterateCallbacks("cachedResponseWillBeUsed"))),
                                (e.prev = 11),
                                u.s();
                            case 13:
                              if ((h = u.n()).done) {
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 11:
                              ...
                              throw new y("cache-put-with-no-response", { url: A(i.url) });
                            case 14:
                            ...
                            case 23:
                              ...
                              return (t.next = 28), P(f, i.clone(), ["__WB_REVISION__"], h);
                            case 28:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ...
                              (a = t),
                                (i = S(this.iterateCallbacks("cacheKeyWillBeUsed"))),
                                (e.prev = 4),
                                i.s();
                            case 6:
                              if ((s = i.n()).done) {
                    ...
                    return R().wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              (n = S(this.iterateCallbacks(t))), (e.prev = 1), n.s();
                            case 3:
                              if ((a = n.n()).done) {
                                e.next = 9;
                                break;
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              (r = t),
                                (n = !1),
                                (a = S(this.iterateCallbacks("cacheWillUpdate"))),
                                (e.prev = 3),
                                a.s();
                            case 5:
                              if ((i = a.n()).done) {
                            ...
                            case 26:
                              return (
                                n || (r && 200 !== r.status && (r = void 0)), e.abrupt("return", r)
                              );
                            case 28:
                            case "end":
                              return e.stop();
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                (e.next = 2),
                                t.runCallbacks("handlerWillStart", { event: n, request: r })
                              );
                            case 2:
                            ...
                            case 11:
                              ...
                              (i = S(t.iterateCallbacks("handlerDidError"))), (e.prev = 15), i.s();
                            case 17:
                              if ((s = i.n()).done) {
                                e.next = 26;
                                break;
                            ...
                            case 38:
                              0;
                            case 39:
                              (o = S(t.iterateCallbacks("handlerWillRespond"))),
                                (e.prev = 40),
                                o.s();
                            case 42:
                              if ((u = o.n()).done) {
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 24:
                              (u = t.t0),
                                e.groupCollapsed("Precaching is responding to: " + A(r.url)),
                                e.log(
                  ...
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    if ("string" !== typeof a && a.integrity) {
                      if (
                        ...
                        throw new y("add-to-cache-list-conflicting-integrities", { url: c });
    ...
    var Le,
      ...
      Se = (function () {
        function e(t, r) {
          var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ce;
          s(this, e), (this.handler = Oe(r)), (this.match = t), (this.method = n);
        }
        return (
          i(e, [
            {
      ...
      Pe = (function () {
        function e() {
          s(this, e), (this._routes = new Map()), (this._defaultHandlerMap = new Map());
        }
        return (
          i(e, [
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (!(t > -1)) throw new y("unregister-route-route-not-registered");
      ...
      Te = function () {
        return Le || ((Le = new Pe()).addFetchListener(), Le.addCacheListener()), Le;
      };
    function De(e, t, r) {
      var n;
      if ("string" === typeof e) {
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                ((r = new URL(e, location.href)).hash = ""), (t.next = 4), r.href
                              );
                            case 4:
                            ...
                            case 7:
                              ...
                              return ((s = new URL(a.href)).pathname += i), (t.next = 12), s.href;
                            case 12:
                              if (!c) {
                                t.next = 17;
                                break;
                              ...
                              return (
                                ((u = new URL(a.href)).pathname += ".html"), (t.next = 17), u.href
                              );
                            case 17:
                              if (!o) {
                                t.next = 36;
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 21:
                              ...
                              throw new y("no-response", { url: t.url, error: i });
                            case 24:
                              return e.abrupt("return", a);
                            case 25:
                            case "end":
    ...
    self.addEventListener("activate", function () {
      ...
      (function (e) {
        ...
        { revision: "84fc2c72efd7e2a105fe6e7de1bde1a3", url: "/index.html" },
        { revision: null, url: "/static/css/main.14c851c7.css" },
        { revision: null, url: "/static/js/787.c09b9ed3.chunk.js" },
        { revision: null, url: "/static/js/main.651e92d3.js" },
        { revision: null, url: "/static/media/1.53260c5213f9b5f0fdae.jpg" },
      ]),
      (function (e) {
        var t = Ee();
        De(new Ne(t, e));
    ...
    De(
      ...
      De(
        ...
        new Ae({ cacheName: "images", plugins: [new ve({ maxEntries: 50 })] })
      ),
